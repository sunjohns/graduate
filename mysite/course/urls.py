...
from course.views import AboutView
from course.views import CourseListView
from course.views import ManageCourseListView
from course.views import CreateCourseView
from course.views import DeleteCourseView, CreateLessonView, ListLessonsView, DetailLessonView, StudentListLessonView
